...
<ol>
  ...
  <li>
  <p>
  Please report the items your group decided to include in the final ranking. Justify each item in about a sentence.
  </p>
  <input bind:value={response1} />
  </li>
</ol>
</p>
...
<ol>
  ...
  <li>
  Please rate how much you feel you have contributed to the group discussion (1-5).
