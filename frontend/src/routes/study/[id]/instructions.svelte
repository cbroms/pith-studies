...
<div class="container-outer">
  ...
  <ol>
    ...
    <li>
      You should see a timer in the upper left corner. This timer indicates how much time you have left before you must be in the waiting room. 
    </li>
    <li>
      On the next page, you will follow a tutorial to use the platform.
    </li>
    <li>
      Once you are done with the tutorial, you will be redirected to the waiting room. The "Ready" button will appear around the end of the countdown. <strong>Please do not leave the waiting room during this time.</strong> Once the button appears, please click on it to join the discussion. You will be given a minute to click on the button.
    </li>
    <li>
